...
| Source | Example |
|---|---|
| GitHub | `letta skills install https://github.com/owner/repo``letta skills install https://github.com/owner/repo/tree/main/path/to/skill``letta skills install https://github.com/owner/repo/blob/main/path/to/skill/SKILL.md` |
