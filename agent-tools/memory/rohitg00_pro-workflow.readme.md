...
- Use `rohitg00/pro-workflow` (the GitHub form), not the bare name — `skills add` resolves providers from `owner/repo`, not marketplace slugs.
...
Manual install (any agent, any OS)
...
Full list: [`commands/`](./commands) · [`skills/`](./skills) · [`/list`](./commands/list.md) inside any session.
...
> "Write detailed specs and reduce ambiguity before handing work off." — [Boris Cherny](https://x.com/bcherny/status/2017742752566632544)
